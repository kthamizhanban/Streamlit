...
with tab_exp:
    ...
    experience_table = pd.DataFrame({
            ...
            "Job Description":["Successfully spearheaded a project to migrate ETL pipelines, achieving a 100% reduction in processing time; enhanced Informatica Intelligent Cloud Services, resulting in a 60% improvement in data processing speed; led a user story design, saving 4 labor hours daily and increasing project efficiency by 25%; automated Power BI reports, reducing manual efforts by 95%; and provided technical mentorship to junior team members for improved autonomy and leadership.","Skilled in Lexi integration for real-time data integrity, MuleSoft log monitoring, Python/SQL automation yielding 80% processing time reduction, and TIGER tool utilization for 20% efficiency improvement, while conducting analyses for comprehensive historical views.","Developed Informatica mappings, sessions, tasks, and workflows for efficient extraction of XML-formatted data, implemented post-processing shell scripts, formulated diverse unit test cases, managed Service Requests, and established an Enterprise Data Warehouse for delivering valuable data insights to clients."],
    })
